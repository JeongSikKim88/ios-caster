...
//  ios-movstone
//
//  Created by JeongSik Kim on 16/01/2019.
...
class AssetPersistenceManager: NSObject {
    ...
    /// Returns the current download state for a given Asset.https://devstreaming-cdn.apple.com/videos/streaming/examples/bipbop_4x3/bipbop_4x3_variant.m3u8
